...
# Further filtering of mcomp dmc results
```shell
mcomppost -i /mnt/d/data/epiLungCancer/raw/moabs/dmc/dmc.CTL.vs.LUAD_LUSC_LCC_SCLC.txt -m /mnt/d/data/epiLungCancer/raw/moabs/merge.d3.all.bed.g
